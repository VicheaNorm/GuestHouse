...
CREATE TABLE `expense_detail` (
  ...
  CONSTRAINT `expense_detail_ibfk_2` FOREIGN KEY (`expenseType_id`) REFERENCES `expensetype` (`expenseType_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `expense_detail_ibfk_3` FOREIGN KEY (`expense_id`) REFERENCES `expense` (`expense_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-01-04 11:40:15
