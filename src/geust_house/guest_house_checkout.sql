...
CREATE TABLE `checkout` (
  ...
  CONSTRAINT `checkout_ibfk_5` FOREIGN KEY (`cus_id`) REFERENCES `customer` (`cus_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `checkout` VALUES (1,'2020-01-10 00:00:00',2,1,6);
